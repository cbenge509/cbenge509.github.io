...
exports.ESLINT_IGNORE = exports.ESLINT_CONFIG = void 0;
...
exports.ESLINT_CONFIG = `let customConfig = [];
...
`;
exports.ESLINT_IGNORE = "module.exports = ['build/']\n";
...
async function generateESLintConfig(options) {
    return generateConfigFile(options, './eslint.config.js', exports.ESLINT_CONFIG);
}
